...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2026 at 05:27 PM
...
INSERT INTO `tbkamar` (`idKamar`, `jenisKamar`, `nomorKamar`, `statusKamar`) VALUES
(5, 'standar', '1', 'Terisi');
...
--
ALTER TABLE `tbkamar`
  MODIFY `idKamar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
